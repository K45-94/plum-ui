<template>
  <div class="page absolute-top fit bg-white">
    ...
    >
      ...
      >
        <!--v-if--><a
          class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle text-white q-btn--actionable q-focusable q-hoverable q-btn--no-uppercase q-btn--dense absolute-right q-mr-md q-ml-xs q-mb-xs small-screen-only absolutely-right"
          tabindex="0"
          href="#/auth"
          ...
          ><span
            ...
            ><i
              class="q-icon eva eva-log-out-outline"
              aria-hidden="true"
              role="img"
            >
            </i></span></a
        ><a
          class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round q-btn--actionable q-focusable q-hoverable q-btn--dense large-screen-only q-mr-sm"
          tabindex="0"
          href="#/camera"
          ...
          ><span
            class="q-btn__content text-center col items-center q-anchor--skip justify-center row"
            ><i
              class="q-icon eva eva-camera-outline"
              aria-hidden="true"
              role="img"
            >
            </i></span
        ></a>
        <hr
          class="q-separator q-separator--vertical large-screen-only"
        ...
        <a
          ...
          ><span
            class="q-btn__content text-center col items-center q-anchor--skip justify-center row"
            ><i
              class="q-icon eva eva-square-outline"
              aria-hidden="true"
              role="img"
            >
            </i></span
        ...
        >
          <span class="q-pa-md"
            >PLUM
            <i
              class="q-icon text-black q-pa-md"
              aria-hidden="true"
              role="presentation"
              ><svg
                width="48px"
        ...
        <a
          class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round q-btn--actionable q-focusable q-hoverable q-btn--dense large-screen-only"
          tabindex="0"
          href="#/"
          style="font-size: 18px"
          ><span class="q-focus-helper"></span
          ><span
            class="q-btn__content text-center col items-center q-anchor--skip justify-center row"
            ><i
              class="q-icon eva eva-home-outline"
              aria-hidden="true"
              role="img"
            >
            </i></span
        ...
        <a
          ...
          ><span
            class="q-btn__content text-center col items-center q-anchor--skip justify-center row"
            ><i
              class="q-icon eva eva-bulb-outline"
              aria-hidden="true"
              role="img"
            >
            </i></span
        ...
        <a
          ...
          ><span
            class="q-btn__content text-center col items-center q-anchor--skip justify-center row"
            ><i
              class="q-icon eva eva-search-outline"
              aria-hidden="true"
              role="img"
            >
            </i></span
